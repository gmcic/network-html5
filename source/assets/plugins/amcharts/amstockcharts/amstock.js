(function() {
    ...
    d.AmStockChart = d.Class({
        ...
        createLayout: function() {
            var a = this.div, b, c, e = this.classNamePrefix, d = document.createElement("div");
            ...
            if (a = this.dataSetSelector)
                c = a.position;
            if ("left" == b || "left" == c)
                a = document.createElement("div"), a.className = e + "-left-div", a.style.cssFloat = "left", a.style.styleFloat = "left", a.style.width = "0px", a.style.position = "absolute", d.appendChild(a), this.leftContainer = a;
            if ("right" == b || "right" == c)
                b = document.createElement("div"), b.className = e + "-right-div", b.style.cssFloat = "right", b.style.styleFloat = "right", b.style.width = "0px", d.appendChild(b), this.rightContainer = b;
            ...
            if (this.div) {
                ...
                if (c != this.prevPH) {
                    ...
                    for (b = 0; b < a.length; b++)
                        if (l = a[b])
                            l.percentHeight = l.percentHeight / e * 100, l.panelBox && (l.panelBox.style.height = Math.round(l.percentHeight * this.panelsHeight / 100) + "px");
                    this.prevPH = c
                }
            }
        },
        addStockPanel: function(a, b) {
            ...
            if (e = a.stockLegend)
                e = d.processObject(e, d.StockLegend, this.theme), e.container = void 0, e.title = a.title, e.marginLeft = c.marginLeft, e.marginRight = c.marginRight, e.verticalGap = 3, e.position = "top", d.copyProperties(this.legendSettings,
        ...
        updatePanel: function(a) {
            ...
            var c = a.valueAxes, e = c.length, f;
            ...
            e = c.length;
            for (b = 0; b < e; b++)
                f = c[b], d.copyProperties(this.valueAxesSettings, f);
            a.listenersAdded=!1;
            a.write(a.panelBox)
        },
        zoom: function(a, b) {
        ...
        addChartScrollbar: function() {
            ...
            if (a.enabled) {
                ...
                b.marginTop = 0;
                b.marginBottom = 0;
                var c = e.dateFormats, f = b.categoryAxis;
        ...
        addPeriodSelector: function() {
            ...
            if (a) {
                ...
                c && (e = c.position);
                var c = this.panelsSettings.panelSpacing, f = document.createElement("div");
                this.periodSelectorContainer = f;
                var l = this.leftContainer, k = this.rightContainer, h = this.centerContainer, m = this.panelsContainer, g = a.width + 2 * c + "px";
                switch (a.position) {
                    case "left":
        ...
        addDataSetSelector: function() {
            ...
            if (a) {
                ...
                this.dssContainer = e;
                var d = this.leftContainer, l = this.rightContainer,
                    k = this.centerContainer, h = this.panelsContainer, c = a.width + 2 * c + "px";
                switch (b) {
                    case "left":
        ...
        handleCursorZoom: function(a) {
            ...
            if (this.categoryAxesSettings.equalSpacing) {
                var d = this.mainDataSet.categoryField, f = this.mainDataSet.agregatedDataProviders[this.currentPeriod];
        ...
        zoomChart: function(a, b) {
            var c = this;
            a || (a = c.firstDate);
            var e = d.newDate(a), f = c.firstDate, l = c.lastDate, k = c.currentPeriod, h = c.categoryAxesSettings, m = h.minPeriod, g = c.panelsSettings, p = c.periodSelector, r = c.panels, u = c.comparedGraphs, x = c.scrollbarChart, y = c.firstDayOfWeek;
            if (f && l) {
                a || (a = f);
                b || (b = l);
                if (k) {
                ...
                c.currentPeriod = k;
                var m = d.extractPeriod(k), z = d.getPeriodDuration(m.period, m.count);
                ...
                for (f = 0; f < r.length; f++)
                    l = r[f], l.chartCursor && l.chartCursor.panning && (n = e);
                for (f = 0; f < r.length; f++) {
                    l = r[f];
                    if (k != h) {
                        for (e = 0; e < u.length; e++)
                            z = u[e].graph, z.dataProvider = z.dataSet.agregatedDataProviders[k];
                        e = l.categoryAxis;
                        e.firstDayOfWeek = y;
                        e.minPeriod = k;
            ...
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (k = 0; k < l.length; k++) {
                        var g = l[k], g = d.processObject(g, d.StockGraph, this.theme);
                        l[k] = g;
                        if (!g.title || g.resetTitleOnDataSetChange)
                            g.title = e.title, g.resetTitleOnDataSetChange=!0;
                        g.useDataSetColors && (g.lineColor = e.color, g.fillColors = void 0, g.bulletColor = void 0);
                        var p=!1, r = e.fieldMappings;
                        ...
                        if (g.comparable) {
                            ...
                            if (g.valueAxis) {
                                ...
                                var E;
                                for (E = 0; E < B; E++) {
                                    var C = f[E], t = g.comparedGraphs[C.id];
                                    ...
                                    if (p) {
                                        ...
                                        if (h = g.compareGraphFillColors)
                                            t.fillColors = h;
                                        if (h = g.compareGraphNegativeFillColors)
                                            t.negativeFillColors = h;
                                        if (h = g.compareGraphFillAlphas)
                                            t.fillAlphas = h;
                                        if (h = g.compareGraphNegativeFillAlphas)
                                            t.negativeFillAlphas = h;
                                        if (h = g.compareGraphBullet)
                                            t.bullet = h;
                                        if (h = g.compareGraphNumberFormatter)
                                            t.numberFormatter =
                                                h;
                                        h = g.compareGraphPrecision;
                                        isNaN(h) || (t.precision = h);
                                        if (h = g.compareGraphBalloonText)
                                            t.balloonText = h;
                                        ...
                                        if (h = g.compareGraphBulletBorderColor)
                                            t.bulletBorderColor = h;
        ...
        choosePeriod: function(a, b, c) {
            var e = this.categoryAxesSettings, f = e.groupToPeriods, l = f[a], k = f[a + 1], h = d.extractPeriod(l), h = d.getPeriodDuration(h.period, h.count), m = b.getTime(), g = c.getTime(), p = e.maxSeries;
        ...
        validateSizeReal: function() {
            ...
            this.measure();
            if (this.divRealWidth != this.previousWidth || this.divRealHeight != this.previousHeight)
                0 < this.divRealWidth && 0 < this.divRealHeight && this.fire("resized", {
                    type: "resized",
                    chart: this
    ...
    d.PeriodSelector = d.Class({
        ...
        write: function(a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                b.startDateField = g;
                if (f)
                    m = b.width - 6 + "px", d.addBr(h);
                else {
                    var m = b.inputFieldWidth + "px", p = document.createTextNode(" ");
                    h.appendChild(p)
                }
                g.style.width = m;
            ...
            if (d.ifArray(h)) {
                ...
                for (a = 0; a < h.length; a++)
                    g = h[a], r = document.createElement("input"),
        ...
        selectPeriodButton: function(a, b, c) {
            var e = a.button, f = e.count, l = e.period, k = this.chart, h, m, g = this.firstDate, p = this.lastDate, r, u = this.theme;
        ...
        markButtonAsSelected: function() {
            if (!this.skipMark) {
                var a = this.chart, b = this.periods, c = a.startDate.getTime(), e = a.endDate.getTime(), f = this.lastDate.getTime();
                e > f && (e = f);
                f = this.theme;
                this.unselectButtons();
                var l;
                for (l = b.length - 1; 0 <= l; l--) {
                    var k = b[l], h = k.button;
        ...
        unselectButtons: function() {
            var a =
                this.chart, b = this.periods, c, e = this.theme;
            for (c = b.length - 1; 0 <= c; c--) {
                var f = b[c].button;
...
(function() {
    ...
    d.StockPanel = d.Class({
        ...
        createDrawIcons: function() {
            var a = this, b = a.iconSize, c = a.container, e = a.pathToImages, f = a.realWidth - 2 * b - 1 - a.marginRight, l = d.rect(c, b, b, "#000", .005), k = d.rect(c, b, b, "#000", .005);
            k.translate(b + 1, 0);
        ...
        handleEraserClick: function() {
            ...
            if (this.eraseAll) {
                ...
                this.validateNow()
            } else (this.erasingEnabled = b=!this.erasingEnabled)
                ? (a && a.show(), this.setTrendColorHover(this.trendLineColorHover), this.setMouseCursor("auto")) : (a && a.hide(), this.setTrendColorHover())
        },
        ...
        handleDraw: function(a) {
            ...
            this.drawOnAxis = b;
            var c = this.categoryAxis, e = a.initialX, f = a.finalX, l = a.initialY;
            a = a.finalY;
        ...
        handleWheelReal: function(a, b) {
            ...
            if (!this.wheelBusy && c) {
                ...
                b && (d =
                    - 1);
                var c = c.chartScrollbar, f = this.categoryAxis.minDuration();
...
(function() {
    ...
    d.parseStockData = function(a, b, c, e, f) {
        var l = {}, k = a.dataProvider, h = a.categoryField;
        if (h) {
            var m = d.getItemIndex(b, c), g = c.length, p, r = k.length, u, x = {};
            for (p = m; p < g; p++)
                u = c[p], l[u] = [];
            var y = {}, n = a.fieldMappings, z = n.length;
            for (p = 0; p < r; p++) {
                var A = k[p], B = d.getDate(A[h], f, b), E = B.getTime(), C = {};
                for (u = 0; u < z; u++)
                    C[n[u].toField] = A[n[u].fromField];
                var t;
                for (t = m; t < g; t++) {
                    u = c[t];
                    var v = d.extractPeriod(u), D = v.period, G = v.count, w, q;
                    if (t == m || E >= x[u] ||!x[u]) {
                        y[u] = {};
                        y[u].amCategoryIdField = String(d.resetDateToMin(B, D, G, e).getTime());
                        var F;
                        for (F = 0; F < z; F++)
                            v = n[F].toField, w = y[u], q = Number(C[v]), w[v + "Count"] = 0, isNaN(q) || (w[v + "Open"] = q, w[v + "Sum"] = q, w[v + "High"] = q, w[v + "AbsHigh"] = q, w[v + "Low"] = q, w[v + "Close"] = q, w[v + "Count"] = 1, w[v + "Average"] = q);
                        w.dataContext = A;
                        l[u].push(y[u]);
                        t > m && (v = d.newDate(B, b), v = d.changeDate(v, D, G, !0), v = d.resetDateToMin(v, D, G, e), x[u] = v.getTime());
                        if (t == m)
                            for (var H in A)
                                A.hasOwnProperty(H) && (y[u][H] = A[H]);
                        y[u][h] = d.newDate(B, b)
                    } else
                        for (D = 0; D < z; D++)
                            v = n[D].toField, w = y[u], p == r - 1 && (w[h] = d.newDate(B, b)), q = Number(C[v]), isNaN(q) || (isNaN(w[v + "Low"]) && (w[v + "Low"] = q), q < w[v + "Low"] && (w[v + "Low"] = q), isNaN(w[v + "High"]) && (w[v + "High"] = q), q > w[v + "High"] && (w[v + "High"] = q), isNaN(w[v + "AbsHigh"]) && (w[v + "AbsHigh"] = q), Math.abs(q) > w[v + "AbsHigh"] &&
    ...
    d.parseEvents = function(a, b, c, e, f, l) {
        var k = a.stockEvents, h = a.agregatedDataProviders, m = b.length, g, p, r, u, x, y, n, z, A;
        for (g = 0; g < m; g++) {
            y = b[g];
            x = y.graphs;
            r = x.length;
            var B;
            for (p = 0; p < r; p++)
                u = x[p], u.customBulletField = "amCustomBullet" + u.id + "_" + y.id, u.bulletConfigField =
                    "amCustomBulletConfig" + u.id + "_" + y.id;
            for (A = 0; A < k.length; A++)
                if (n = k[A], B = n.graph, d.isString(B) && (B = d.getObjById(x, B)))
                    n.graph = B
        }
        for (var E in h)
            if (h.hasOwnProperty(E)) {
                B = h[E];
                var C = d.extractPeriod(E), t = B.length, v;
                for (v = 0; v < t; v++) {
                    var D = B[v];
                    g = D[a.categoryField];
                    z = g instanceof Date;
                    ...
                    for (g = 0; g < m; g++)
                        for (y = b[g], x = y.graphs, r = x.length,
                            ...
                            for (A = 0; A < k.length; A++) {
                                ...
                                z = n.date.getTime();
                                var F=!1;
                                n.graph && (n.graph.showEventsOnComparedGraphs && n.graph.comparedGraphs[a.id] && (F=!0),
...
(function() {
    ...
    d.DataSetSelector = d.Class({
        ...
        write: function(a) {
            var b = this, c, e = b.theme, f = b.chart;
        ...
        handleCBSelect: function(a) {
            var b = this.compareCB, c = this.dataProvider, d, f;
...
(function() {
    ...
    d.StackedBullet = d.Class({
        ...
        addLetter: function(a, b, c) {
            ...
            b = e.set();
            var f =- 1, l = this.stackDown, k = this.graph.valueAxis;
            this.showOnAxis && (this.stackDown = k.reversed?!0 : !1);
            this.stackDown && (f = 1);
            var h = 0, m = 0, g = 0, p, r = this.fontSize, u = this.mastHeight, x = this.shape, y = this.textColor;
        ...
        drawSign: function(a) {
            var b =- 1;
            this.stackDown && (b = 1);
            var c = this.mastHeight * b, e = this.fontSize / 2 + 2, f = d.line(this.container, [0, 0], [0, c], this.borderColor, this.borderAlpha, 1), l = d.circle(this.container, e, this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
            l.translate(0, c + e * b);
            a.push(f);
            a.push(l);
            this.cset.push(a);
        ...
        drawFlag: function(a) {
            var b =- 1;
            this.stackDown && (b = 1);
            var c = this.fontSize + 4, e = this.labelWidth + 6, f = this.mastHeight, b = 1 == b ? b * f: b * f - c, f = d.line(this.container, [0, 0], [0, b], this.borderColor, this.borderAlpha, 1), c = d.polygon(this.container, [0, e, e, 0], [0, 0, c, c], this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
            c.translate(0, b);
            a.push(f);
            a.push(c);
            this.cset.push(a);
        ...
        drawTextBackground: function(a, b) {
            var c = b.getBBox(), d =- c.width / 2 - 5, f = c.width / 2 + 5, c =- c.height - 12;
